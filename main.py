...
# CORS Configuration
# ==========================================
raw_origins = os.getenv("CORS_ALLOWED_ORIGINS", "http://localhost:5173,http://127.0.0.1:5173") # TODO: da cambiare
...
app.add_middleware(
    ...
    allow_methods=["*"],
    allow_headers=["*", "x-api-key", "X-API-Key", "Authorization"],
)
...
def get_current_merchant(request: Request, api_key: Optional[str] = Security(api_key_header), db: Session = Depends(get_db)):
